 ...
 */
class Programas extends \Entities\Programas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Programas' . "\0" . 'id', '' . "\0" . 'Entities\\Programas' . "\0" . 'nome', '' . "\0" . 'Entities\\Programas' . "\0" . 'descricao', '' . "\0" . 'Entities\\Programas' . "\0" . 'parent');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Programas $proxy) {
